...
export default function Page() {
  return (
    <div className="space-y-6">
      <PageHeader title="Lab" description="Overview and management." breadcrumb={[{ label: "Portal" }, { label: "Lab" }]} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[1, 2, 3].map((i) => (
          <Card key={i} padding="lg" className="border-slate-200 hover:border-slate-300 transition-colors cursor-pointer">
            ...
            <p className="text-xs text-slate-500">Seeded dummy data for the Lab module presentation.</p>
          </Card>
        ))}
      </div>
